...
std::array<Parser::PrefixPair, 34> Parser::PREFIX_FNS = {
    ...
    PrefixPair{TokenType::INT_2, ast::SizeInteger::parse},
    PrefixPair{TokenType::INT_8, ast::SizeInteger::parse},
    PrefixPair{TokenType::INT_10, ast::SizeInteger::parse},
    PrefixPair{TokenType::INT_16, ast::SizeInteger::parse},
    PrefixPair{TokenType::UINT_2, ast::SizeInteger::parse},
    PrefixPair{TokenType::UINT_8, ast::SizeInteger::parse},
    PrefixPair{TokenType::UINT_10, ast::SizeInteger::parse},
    PrefixPair{TokenType::UINT_16, ast::SizeInteger::parse},
    PrefixPair{TokenType::UZINT_2, ast::SizeInteger::parse},
    PrefixPair{TokenType::UZINT_8, ast::SizeInteger::parse},
    PrefixPair{TokenType::UZINT_10, ast::SizeInteger::parse},
    PrefixPair{TokenType::UZINT_16, ast::SizeInteger::parse},
