...
[[nodiscard]] static inline Status hash_map_grow(HashMap* hm, size_t new_capacity) {
    assert(hm);
...
[[nodiscard]] static inline Status hash_map_grow_if_needed(HashMap* hm, size_t new_count) {
    assert(hm);
