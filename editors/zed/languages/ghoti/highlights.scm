...
; Arbitrary-width integers (iN / uN, N = 1..65535) and extended floats the grammar
; may still lex as plain identifiers.
((identifier) @type.builtin
  (#match? @type.builtin "^([iu](size|[1-9][0-9]{0,4})|f(16|32|64|80|128))$"))
(identifier) @type
  (#match? @type "^[A-Z]")
