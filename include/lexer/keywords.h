...
#define KEYWORD_LOOP KW("loop", LOOP)
...
static const Keyword ALL_KEYWORDS[] = {
    ...
    KEYWORD_MATCH,    KEYWORD_RETURN, KEYWORD_LOOP,        KEYWORD_FOR,        KEYWORD_WHILE,
    KEYWORD_CONTINUE, KEYWORD_BREAK,  KEYWORD_NIL,         KEYWORD_TYPEOF,     KEYWORD_IMPL,
    KEYWORD_IMPORT,   KEYWORD_INT,    KEYWORD_UINT,        KEYWORD_SIZE,       KEYWORD_FLOAT,
    KEYWORD_BYTE,     KEYWORD_STRING, KEYWORD_BOOL,        KEYWORD_VOID,       KEYWORD_TYPE,
    KEYWORD_WITH,     KEYWORD_AS,
};
