...
#define FOREACH_STATUS(PROCESS)                                                                    \
    PROCESS(SUCCESS), PROCESS(ALLOCATION_FAILED), PROCESS(REALLOCATION_FAILED),                    \
        ...
        PROCESS(INFIX_MISSING_RHS), PROCESS(PREFIX_MISSING_OPERAND), PROCESS(UNEXPECTED_TOKEN),    \
        PROCESS(MALFORMED_INTEGER_STR), PROCESS(MALFORMED_FLOAT_STR), PROCESS(NOT_IMPLEMENTED),    \
        PROCESS(DECL_MISSING_TYPE), PROCESS(CONST_DECL_MISSING_VALUE),                             \
        ...
        PROCESS(ARRAY_ITEM_TYPE_MISMATCH), PROCESS(ILLEGAL_ARRAY_ITEM)
